...
@ComponentScan({"com.stu.infra.cdc.configuration"})
...
public class HibernateConfig {
	...
	public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan(new String[] { "com.stu.infra.cdc.model" });
    ...
    public DataSource dataSource() {
		...
		try { dataSource.setDriverClass(environment.getRequiredProperty("jdbc.driverClassName")); } catch (Exception e) {}
	...
	private Properties hibernateProperties() {
        ...
        if(!environment.getProperty("hibernate.hbm2ddl.auto").trim().equals("")) properties.put("hibernate.hbm2ddl.auto", environment.getProperty("hibernate.hbm2ddl.auto"));
        return properties;        
    }
