...
public class HttpClientUtil {
	...
	public static String post(String postUrl, Map<String, String> params, Map<String, String> files) 
	        ...
	        try {
	            ...
	            try {
	            	...
	            	t.printStackTrace();
	            	//LoggerFactory.getLogger(HttpClientUtils.class).error(t.getMessage());            	
	            }
